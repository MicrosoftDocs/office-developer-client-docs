...
description: Outlines the PidTagHomeAddressStateOrProvince canonical property, which contains the state or province portion of a user's address.
manager: soliver
ms.date: 03/09/2015
...
|Property|Value|
|:-----|:-----|
|Associated properties:  <br/> |PR_HOME_ADDRESS_STATE_OR_PROVINCE, PR_HOME_ADDRESS_STATE_OR_PROVINCE_A, PR_HOME_ADDRESS_STATE_OR_PROVINCE_W  <br/> |
|Identifier:  <br/> |0x3A5C  <br/> |
