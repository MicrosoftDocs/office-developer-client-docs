...
description: "Specifies the word count of the file that is attached to the document for Outlook 2013 or Outlook 2016."
---
...
Specifies the word count of the file that is attached to the document.
  
|Property |Value |
|:-----|:-----|
|Friendly names:  <br/> |None  <br/> |
|Property set:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Property name:  <br/> |WordCount  <br/> |
