...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Bb645534(v=office.15)
...
For more information about Office Developer Tools for Visual Studio, see [Configuring a Computer to Develop Office Solutions](https://msdn.microsoft.com/en-us/library/54ds2za4\(v=office.15\)). For more information about programming managed add-ins for Outlook, see [Getting Started Programming Application-Level Add-ins](https://msdn.microsoft.com/en-us/library/ms268878\(v=office.15\)).
