...
If Outlook is not running on the local computer, GetApplicationObject creates a new instance of Outlook, uses the [Logon(Object, Object, Object, Object)](/dotnet/api/microsoft.office.interop.outlook._namespace.logon) method of the [NameSpace](https://docs.microsoft.com/dotnet/api/microsoft.office.interop.outlook.namespace) object to sign in to the default profile, and returns that new instance of Outlook.
