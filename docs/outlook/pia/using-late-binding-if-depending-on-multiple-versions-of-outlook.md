...
Late binding involves an add-in calling the [IDispatch](/windows/win32/api/oaidl/nn-oaidl-idispatch) interface implemented by Outlook. To use late binding in Visual C\#, use the [System.Type.InvokeMember](/dotnet/api/system.type.invokemember?view=netframework-4.7.2) method. This method calls [IDispatch::GetIDsOfNames](/windows/win32/api/oaidl/nf-oaidl-idispatch-getidsofnames) and [IDispatch::Invoke](/windows/win32/api/oaidl/nf-oaidl-idispatch-invoke) to bind to Outlook’s methods and properties. The IDispatch::GetIDsOfNames method allows Visual C\# to interrogate an object about what methods and properties it supports and the IDispatch::Invoke method then allows Visual C\# to call those methods and properties. 
