---
title: 'How to: Create a Rule to Assign Categories to Mail Items Based on Multiple Words in the Subject'
TOCTitle: 'How to: Create a Rule to Assign Categories to Mail Items Based on Multiple Words in the Subject'
