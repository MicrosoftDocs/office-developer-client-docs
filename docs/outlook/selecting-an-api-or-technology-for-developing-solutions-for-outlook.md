...
For more information and code samples, see the [Outlook MAPI Reference](https://learn.microsoft.com/office/client-developer/outlook/mapi/outlook-mapi-reference) and [MFCMAPI](https://stephenegriffin.github.io/mfcmapi/).
