...
|:-----|:-----|:-----|:-----|:-----|
|IX  <br/> |xsd:unsignedInt  <br/> |required  <br/> |The index of the **Para** element that specifies the formatting applied to this run. |Values of the xsd:unsignedInt type. |
