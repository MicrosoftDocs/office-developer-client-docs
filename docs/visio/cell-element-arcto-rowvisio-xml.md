...
|:-----|:-----|:-----|
|[Row element (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |Contains the x- and y-coordinates and bow of a circular arc. |
   
### Child elements

|**Element**|**Type**|**Description**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Contains the x coordinate, y coordinate, or bow of a circular arc. |
...
|:-----|:-----|:-----|
|A  <br/> |The distance from the arc's midpoint to the midpoint of its chord. |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
|X  <br/> |The x-coordinate of the ending vertex of an arc. |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
|Y  <br/> |The y-coordinate of the ending vertex of an arc. |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
