...
|:-----|:-----|:-----|
|[Row element (Tabs Section)](row-element-tabs-sectionvisio-xml.md) <br/> |[TabsRow_Type](tabsrow_type-complextypevisio-xml.md) <br/> |Specifies a property that controls shape and style tab stop position or alignment. |
...
|:-----|:-----|:-----|
|Alignment  <br/> |Specifies the tab alignment. |[Alignment Cell (Tabs Section)](alignment-cell-tabs-section.md) <br/> |
|Position  <br/> |Specifies the position of a tab stop. The tab position is independent of the scale of the drawing. If the drawing is scaled, the tab position remains the same. |[Position Cell (Tabs Section)](position-cell-tabs-section.md) <br/> |
