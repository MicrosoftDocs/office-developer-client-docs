...
description: "ModernComments (VisioDocument_Type complexType) specifies properties used to identify the parent comment and mentions present in a drawing comment."
ms.date: 02/18/2022
---
