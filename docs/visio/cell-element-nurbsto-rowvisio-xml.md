...
|:-----|:-----|:-----|
|X  <br/> |The x-coordinate of the last control point of a NURBS. |[NURBSTo Row (Geometry Section)](nurbsto-row-geometry-section.md) <br/> |
|Y  <br/> |The y-coordinate of the last control point of a NURBS. |[NURBSTo Row (Geometry Section)](nurbsto-row-geometry-section.md) <br/> |
|A  <br/> |The second to the last knot of the NURBS. |[NURBSTo Row (Geometry Section)](nurbsto-row-geometry-section.md) <br/> |
|B  <br/> |The last weight of the NURBS. |[NURBSTo Row (Geometry Section)](nurbsto-row-geometry-section.md) <br/> |
|C  <br/> |The first knot of the NURBS. |[NURBSTo Row (Geometry Section)](nurbsto-row-geometry-section.md) <br/> |
|D  <br/> |The first weight of the NURBS. |[NURBSTo Row (Geometry Section)](nurbsto-row-geometry-section.md) <br/> |
|E  <br/> |A NURBS formula. |[NURBSTo Row (Geometry Section)](nurbsto-row-geometry-section.md) <br/> |
