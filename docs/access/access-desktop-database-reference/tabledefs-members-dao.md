...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Ff196175(v=office.15)
...
<td><p>Adds a new <strong>TableDef</strong> to the <strong>TableDefs</strong> collection.</p></td>
</tr>
<tr class="even">
<td><p><strong><a href="tabledefs-delete-method-dao.md">Delete</a></strong></p></td>
<td><p>Deletes the specified <strong>TableDef</strong> object from the <strong>TableDefs</strong> collection.</p></td>
</tr>
<tr class="odd">
