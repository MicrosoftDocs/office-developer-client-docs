...
description: "This example demonstrates how the Item property accesses members of a collection. The example opens the Authors table of the Pubs database with a parameterized command."
---
