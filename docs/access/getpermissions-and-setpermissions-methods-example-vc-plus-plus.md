...
description: "This example demonstrates the GetPermissions and SetPermissions methods. The following code gives full access to the Orders table to the Admin user."
---
