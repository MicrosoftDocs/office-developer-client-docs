...
You can't use the **Requery** method on dynaset- or snapshot-type **Recordset** objects whose **[Restartable](recordset2-restartable-property-dao.md)** property is set to **False**. However, if you supply the optional  _newquerydef_ argument, the **Restartable** property is ignored. 
