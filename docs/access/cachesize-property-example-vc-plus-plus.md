...
description: "This example uses the CacheSize property to show the difference in performance for an operation performed with and without a 30-record cache."
---
