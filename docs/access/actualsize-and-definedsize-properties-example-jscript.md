...
description: "This example uses the ActualSize and DefinedSize properties to display the defined size and actual size of a field. Cut and paste the following code to Notepad or another text editor, and save it as ActualSizeJS.asp ."
---
