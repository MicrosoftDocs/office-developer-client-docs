...
If you write past the current [EOS](eos-property-ado.md) position, the [Size](/office/vba/access/concepts/miscellaneous/size-property-ado-stream) of the **Stream** will be increased to contain any new bytes, and **EOS** will move to the new last byte in the **Stream**.
