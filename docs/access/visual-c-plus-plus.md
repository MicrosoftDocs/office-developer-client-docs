...
description: "This is a schematic description of how to instantiate ADO events in Microsoft Visual C++. See ADO Events Model Example (VC++) for a complete description."
---

# Visual C++

This is a schematic description of how to instantiate ADO events in Microsoft Visual C++. See [ADO Events Model Example (VC++)](ado-events-model-example-vc-plus-plus.md) for a complete description. 
