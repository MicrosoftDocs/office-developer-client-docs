...
description: "This example demonstrates how to read the contents of a text box into both a text Stream and a binary Stream . Other properties and methods shown include Position, Size, Charset, and SetEOS."
---
